...
public class JGenerator {
	...
	// FIXME 生成的文件表前缀
	private static final String TABLI_PREFIX = "tb_";
	// FIXME 是否移除表前缀
	private static final boolean IS_TABLI_PREFIX = true;


	// FIXME 数据库名
	private static final String DB_NAME = "mic_service_test";

	// FIXME mysql地址
	private static final String DATA_SOURCE_IP  = "192.168.101.65";
	...
	// FIXME mysql驱动
	private static final String DATA_SOURCE_DRIVER  = "com.mysql.cj.jdbc.Driver";//"com.mysql.cj.jdbc.Driver"

	// FIXME 生成表的作者
	private static final String AUTHOR = "jijinliang";
